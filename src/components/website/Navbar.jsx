...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      const clickedInsideDesktopAccount =
        accountDropdownRef.current &&
        accountDropdownRef.current.contains(event.target);

      const clickedInsideMobileAccount =
        mobileAccountDropdownRef.current &&
        mobileAccountDropdownRef.current.contains(event.target);

      if (
        !clickedInsideDesktopAccount &&
        !clickedInsideMobileAccount
      ) {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-[9999] w-full bg-white">
        ...
        <div
          className={`overflow-hidden bg-[#1976c8] text-white transition-all duration-500 ease-in-out ${scrolled
              ? "h-0 opacity-0"
              : "h-[37px] opacity-100"
            }`}
        >
          ...
          <div className="mx-auto flex h-full max-w-[1400px] items-center px-4">
              ...
              <ul className="m-0 flex list-none items-center gap-[29px] p-0">
                ...
                <li>
                  <button
                    type="button"
                    onClick={() => scrollToSection("home")}
                    className={`relative flex h-[70px] items-center border-0 bg-transparent px-0 text-[14px] no-underline transition-colors duration-300 ${activeSection === "home"
                ...
                <li>
                  <button
                    ...
                    className={`relative flex h-[70px] items-center border-0 bg-transparent px-0 text-[14px] no-underline transition-colors duration-300 ${activeSection === "about"
                        ? "font-medium text-[#1976c8]"
                        : "text-[#444444] hover:text-[#1976c8]"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`relative flex h-[70px] items-center border-0 bg-transparent px-0 text-[14px] no-underline transition-colors duration-300 ${activeSection === "services"
                        ? "font-medium text-[#1976c8]"
                        : "text-[#444444] hover:text-[#1976c8]"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`relative flex h-[70px] items-center border-0 bg-transparent px-0 text-[14px] no-underline transition-colors duration-300 ${activeSection === "departments"
                        ? "font-medium text-[#1976c8]"
                        : "text-[#444444] hover:text-[#1976c8]"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`relative flex h-[70px] items-center border-0 bg-transparent px-0 text-[14px] no-underline transition-colors duration-300 ${activeSection === "doctors"
                        ? "font-medium text-[#1976c8]"
                        : "text-[#444444] hover:text-[#1976c8]"
                      }`}
                  >
                ...
                >
                  ...
                  >
                    ...
                    <i
                      className={`bi text-[10px] ${dropdownOpen
                          ? "bi-chevron-up"
                          : "bi-chevron-down"
                        }`}
                    ></i>
                ...
                <li>
                  <button
                    ...
                    className={`relative flex h-[70px] items-center border-0 bg-transparent px-0 text-[14px] no-underline transition-colors duration-300 ${activeSection === "contact"
                        ? "font-medium text-[#1976c8]"
                        : "text-[#444444] hover:text-[#1976c8]"
                      }`}
                  >
            ...
            {loggedIn && (
              <div
                ...
                className="relative ml-[18px] hidden items-center lg:flex"
              >
              ...
              <ul className="m-0 flex list-none flex-col p-0">
                ...
                <li>
                  <button
                    ...
                    className={`block w-full rounded-md border-0 px-3 py-3 text-left text-[14px] no-underline ${activeSection === "home"
                ...
                <li>
                  <button
                    ...
                    className={`block w-full rounded-md border-0 px-3 py-3 text-left text-[14px] no-underline ${activeSection === "about"
                        ? "bg-[#f0f7fd] font-medium text-[#1976c8]"
                        : "bg-transparent text-gray-600 hover:bg-gray-50"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`block w-full rounded-md border-0 px-3 py-3 text-left text-[14px] no-underline ${activeSection === "services"
                        ? "bg-[#f0f7fd] font-medium text-[#1976c8]"
                        : "bg-transparent text-gray-600 hover:bg-gray-50"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`block w-full rounded-md border-0 px-3 py-3 text-left text-[14px] no-underline ${activeSection === "departments"
                        ? "bg-[#f0f7fd] font-medium text-[#1976c8]"
                        : "bg-transparent text-gray-600 hover:bg-gray-50"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`block w-full rounded-md border-0 px-3 py-3 text-left text-[14px] no-underline ${activeSection === "doctors"
                        ? "bg-[#f0f7fd] font-medium text-[#1976c8]"
                        : "bg-transparent text-gray-600 hover:bg-gray-50"
                      }`}
                  >
                ...
                <li>
                  <button
                    ...
                    className={`block w-full rounded-md border-0 px-3 py-3 text-left text-[14px] no-underline ${activeSection === "contact"
                        ? "bg-[#f0f7fd] font-medium text-[#1976c8]"
                        : "bg-transparent text-gray-600 hover:bg-gray-50"
                      }`}
                  >
